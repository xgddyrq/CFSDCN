...
parser.add_argument('--outf', type=str, default='./exp/cfsdcn_s/', help='saving_path')
...
parser.add_argument("--milestones", type=int, default=[100,150,200,250,300,400], help='milestones for MultiStepLR')
